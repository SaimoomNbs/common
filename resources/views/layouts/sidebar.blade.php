<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <!-- Language -->
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#languageMenu" 
                class="nav-link {{ request()->routeIs('languages','add.language','language.translator') ? 'active' : '' }}" aria-controls="languageMenu" role="button" 
                aria-expanded="{{ request()->routeIs('languages','add.language','language.translator') ? 'true' : 'false' }}">
                    <div class="icon icon-sm shadow-sm border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <i class="ni ni-compass-04" aria-hidden="true"></i>
                    </div>
                ...
                <div class="collapse {{ request()->routeIs('languages','add.language','language.translator') ? 'show' : '' }}" id="languageMenu">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item {{ request()->routeIs('add.language') ? 'active' : '' }}">
                            <a class="nav-link" href="{{route('add.language')}}">
                                <span class="sidenav-mini-icon"> M </span>
                                <span class="sidenav-normal"> Add Language </span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('languages') ? 'active' : '' }}">
                            <a class="nav-link" href="{{route('languages')}}">
                                <span class="sidenav-mini-icon"> M </span>
                                <span class="sidenav-normal"> Manage Languages </span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('language.translator') ? 'active' : '' }}">
                            <a class="nav-link" href="{{route('language.translator')}}">
                                <span class="sidenav-mini-icon"> T </span>
