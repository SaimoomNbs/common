        ...
        <div>
            <div class="dropdown d-inline">
                ...
                <ul class="dropdown-menu dropdown-menu-lg-start px-2 py-3" aria-labelledby="navbarDropdownMenuLink2" data-popper-placement="left-start">
                    <li><a class="dropdown-item border-radius-md" href="javascript:;">English</a></li>
                    <li><a class="dropdown-item border-radius-md" href="javascript:;">Bangla</a></li>
                    <li><a class="dropdown-item border-radius-md" href="javascript:;">Italian</a></li>
                    <li>
