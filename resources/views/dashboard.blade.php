        ...
        <div class="card">
            <div class="card-body p-3 position-relative overflow-hidden min-height-500">
                ...
                <div id="globe" class="position-absolute end-0 bottom-n2 mt-sm-3 peekaboo">
                    <canvas width="421" height="476" class="w-lg-100 h-lg-100 w-75 h-75 me-lg-0 me-n8 mt-lg-5" style="width: 421px; height: 476.594px;"></canvas>
                </div>
            </div>
        </div>
    </div>
...
<div class="row mt-4">
        ...
        <div class="card z-index-2">
            <div class="card-body p-2">
                <div class="bg-dark border-radius-md py-3 pe-1 mb-3">
                    <div class="chart">
                        <canvas id="chart-bars" class="chart-canvas" height="170" style="display: block; box-sizing: border-box; height: 170px; width: 401px;" width="401"></canvas>
                    </div>
                </div>
    ...
    <div class="col-lg-7">
        <div class="card z-index-2">
            ...
            <div class="card-body p-3">
                <div class="chart">
                    <canvas id="chart-line" class="chart-canvas" height="300" style="display: block; box-sizing: border-box; height: 300px; width: 567px;" width="567"></canvas>
                </div>
            </div>
        </div>
    </div>
